...
#+begin_src emacs-lisp :tangle yes
    ;; (use-package ispell
  ;;     :ensure-system-package (hunspell . "sudo-xbps-install -S hunspell")
  ;;     :custom
  ...
  ;;         (langtool-switch-default-language "el_GR")
  ;;       (langtool-switch-default-language "en_US"))
...
(use-package langtool
  :diminish
  :custom
  (langtool-default-language "en_US")
...
#+begin_src emacs-lisp :tangle yes
  (use-package browse-url
    ...
    (browse-rul-generic-program "firefox"))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
    (use-package dart-mode
      ...
      (dart-sdk-path "/home/charlie/flutter/bin/")
      :config
    ...
    (use-package flutter
      ...
      :custom (flutter-sdk-path "/home/charlie/flutter/bin/"))
...
(use-package markdown-mode
  :ensure-system-package (pandoc . "sudo xbps-install -S pandoc")
  :delight "μ "
  :mode ("\\.markdown\\'" "\\.md\\'")
...
(use-package ledger-mode
  :ensure-system-package (ledger . "sudo xbps-install -S ledger")
  :mode ("\\.dat\\'"
         "\\.ledger\\'")
