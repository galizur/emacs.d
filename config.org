...
#+begin_src emacs-lisp
  (use-package ispell
    ...
    :custom
    (ispellhunspell-dict-paths-alist
...
#+begin_src emacs-lisp
  ...
  (use-package bibtex
    ...
    :hook((bibtex-mode . lsp-deferred)
          (bibtex-mode . my/bibtext-fill-column)))
#+end_src
...
#+begin_src emacs-lisp
  (use-package paradox
    ...
    (padadox-display-star-count nil)
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (font-lock-add-keywords 'orng-mode
                            '(("^ *\\([-]\\) "
  ...
  (use-package org-capture
    ...
    (org-capture-templates
     `(("c" "Contact" entry (file+headline "~/.personal/agenda/contacts.org" "Friends"),
       ...
       ("i" "New Item")
       ("ib" "Book" checkitem (file+headline "~/.personal/other/books.org" "Books")
        "- [ ] %^{Title} -- %^{Author} %? :@home:reading:\n%U"
        :immediate-finish t)
       ("il" "Learning" checkitem (file+headline "~/.personal/other/learning.org" "Things")
        "- [ ] %^{Thing} :@home:"
        :immediate-finish t)
       ("im" "Movie" checkitem (file+headline "~/.personal/other/movies.org" "Movies")
        "- [ ] %^{Title} :@home:watch:\n%U"
        :immediate-finish t)
       ("ip" "Purchase" checkitem (file+headline "~/.personal/other/purchases.org" "Purchases")
        "- [ ] %^{Item} :@home:purchase:\n%U"
        :immediate-finish t)
