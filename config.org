...
#+begin_src emacs-lisp :tangle yes
  ...
  (lsp-clients-clangd-args '("--compile-commands-dir=build-debug" "--clang-tidy" "--cross-file-rename"
                             "--header-insertion=iwyu" "--suggest-missing-includes" "--header-insertion-decorators" "--folding-ranges"))
